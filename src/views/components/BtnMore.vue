  ...
  <div>
    <div class="dropdown-end dropdown-hover dropdown">
      ...
      <ul tabindex="0" class="dropdown-content z-50 flex w-12 flex-col gap-4 rounded-2xl bg-base-100 py-2 shadow">
        <li><Delete :showText="false" class="btn-ghost btn-sm btn w-12"></Delete></li>
        <li><Add :showText="false" class="btn-ghost btn-sm btn w-12"></Add></li>
...
export default defineComponent({
  components: { ChevronDoubleDown, Copy, Delete, Add, Edit, Commit },
});
</script>
