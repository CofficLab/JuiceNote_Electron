<template>
  ...
  <div class="h-8 bg-stone-900 fixed top-0 z-50 w-full flex justify-center" id="title-bar" v-show="!hideTitleBar">
    ...
    <Breadcrumbs class="bg-gradient-to-r from-sky-200/50 via-sky-200/60 to-sky-200/50"></Breadcrumbs>
    <Toast></Toast>
  ...
  <footer class="h-8 fixed z-10 bottom-0 w-full p-0 flex bg-stone-900 justify-center">
    <Address></Address>
  </footer>
</template>
