<template>
  ...
  <main class="flex flex-row z-10" v-bind:class="hideTitleBar ? 'top-0' : 'top-8'">
    <!-- 左侧栏 -->
    <aside
    ...
    <!-- 右侧栏 -->
    <aside
      class="hidden lg:flex w-56 min-h-screen bg-gradient-to-r from-cyan-800/10 to-sky-200/40 pt-32 overflow-scroll fixed top-0 right-0 justify-end"
    >
      <Toc v-show="!editorMode"></Toc>
    </aside>
  </main>

  <footer class="h-8 fixed z-10 bottom-0 w-full p-0 flex">
    <Toast></Toast>
