<template>
  <div class="modal modal-open" @keydown.esc="toggleVisible" v-if="visible">
    <Transition name="bounce">
      <div class="modal-box w-2/3 max-w-2xl relative p-0 h-96  bg-accent/40 backdrop-blur">
        <div class="flex flex-row h-full">
          ...
          <div class="flex flex-col h-full flex-grow gap-4 p-2 pr-4 overflow-scroll">
            <!-- 数据设置 -->
            <SettingData v-if="tab === '数据'"></SettingData>

            <!-- 其他设置 -->
            <SettingAbout v-if="tab === '版本'"></SettingAbout>
