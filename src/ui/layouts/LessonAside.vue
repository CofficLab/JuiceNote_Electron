...
aside {
  @apply fixed left-0 top-0 z-50 hidden h-screen w-40 border-r border-base-300 bg-primary bg-opacity-90 shadow-xl backdrop-blur-sm backdrop-filter lg:flex lg:flex-col;
