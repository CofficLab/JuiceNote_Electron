  ...
  })(
    {
            ...
            (0, l.default)(e, [
              {
                ...
                value: function e() {
                  for (;;) {
                    ...
                    var r = t.text;
                    if (
                      !(r.charAt(0) === "\\" && this.macros.hasOwnProperty(r))
                    ) {
                      return t;
                    }
                    var a = void 0;
      ...
      28: [
        function (e, t, r) {
          ...
          var h = [0.5, 0.6, 0.7, 0.8, 0.9, 1, 1.2, 1.44, 1.728, 2.074, 2.488];
            ...
            (0, l.default)(e, [
              {
                ...
                value: function e(t, r) {
                  if (this.nextToken.text !== t) {
                    throw new M.default(
                      "Expected '" + t + "', got '" + this.nextToken.text + "'",
                      this.nextToken
                    );
                  }
                  if (r !== false) {
              ...
              },
              {
                ...
                value: function t() {
                  ...
                  if (a === "\\left") {
                    ...
                    return new b.default(
                      "leftright",
                      { body: i, left: n.value.value, right: l.value.value },
                      this.mode
                    );
                  } else if (a === "\\begin") {
                    ...
                    return new b.default(
                      "sizing",
                      { size: m.default.indexOf(e.sizeFuncs, a) + 1, value: g },
                      this.mode
                    );
                    ...
                    return new b.default(
                      "styling",
                      { style: a.slice(1, a.length - 5), value: y },
                      this.mode
                    );
                    ...
                    return new b.default(
                      "color",
                      { type: "color", color: k.result.value, value: z },
                      this.mode
                    );
                  } else if (a === "$") {
                    if (this.mode === "math") {
              ...
              },
              {
                ...
                value: function e(t) {
                  ...
                  if (this.nextToken.text === (t ? "[" : "{")) {
                    ...
                    return new S(
                      new b.default("ordgroup", a, this.mode, r, n),
                      false
                    );
                  } else {
                  ...
                  for (var a = 0; a < r; ++a) {
                    ...
                    if (i === "-" && t[a + 1].value === "-") {
                      if (a + 1 < r && t[a + 2].value === "-") {
                        t.splice(
                          a,
                          3,
                          new b.default("textord", "---", "text", n, t[a + 2])
                        );
                        r -= 2;
                      } else {
                        t.splice(
                          a,
                          2,
                          new b.default("textord", "--", "text", n, t[a + 1])
                        );
                        r -= 1;
                      }
                    }
                    if ((i === "'" || i === "`") && t[a + 1].value === i) {
                      t.splice(
                        a,
                        2,
                        new b.default("textord", i + i, "text", n, t[a + 1])
                      );
                      r -= 1;
                    }
                  }
              ...
              },
              {
                ...
                value: function e() {
                  ...
                  if (o.default[t.text]) {
                    ...
                    return new S(
                      new b.default(
                        d.default[this.mode][t.text].group,
                        t.text,
                        this.mode,
                        t
                      ),
                    ...
                    this.consume();
                    return new S(
                      new b.default("textord", t.text, this.mode, t),
                      false,
                      t
                    );
                  } else if (t.text === "$") {
        ...
        function (e, t, r) {
          ...
          var d = function e(t, r, a, i, l) {
            ...
            if (o) {
              ...
              typeof console !== "undefined" &&
                console.warn(
                  "No character metrics for '" + t + "' in style '" + r + "'"
                );
        ...
        function (e, t, r) {
          ...
          var N = function e(t, r) {
            if (!t.value.base) {
              ...
              if (a.type === "op") {
                return (
                  a.value.limits &&
                  (r.style.size === o.default.DISPLAY.size ||
          ...
          E.supsub = function (e, t) {
            ...
            if (e.value.sup) {
              ...
              if (!q(e.value.base)) {
                s =
                  r.height -
                  (l.fontMetrics().supDrop * l.sizeMultiplier) /
                    t.sizeMultiplier;
              }
            }
            if (e.value.sub) {
              ...
              if (!q(e.value.base)) {
                f =
                  r.depth +
                  (l.fontMetrics().subDrop * l.sizeMultiplier) /
                    t.sizeMultiplier;
              }
            }
            var h = void 0;
            ...
            var p = 0.5 / i.ptPerEm / v + "em";
            var m = void 0;
            if (!e.value.sup) {
              f = Math.max(f, i.sub1, n.height - 0.8 * i.xHeight);
              ...
              s = Math.max(s, h, a.depth + 0.25 * i.xHeight);
              m = c.default.makeVList(
                [{ type: "elem", elem: a, marginRight: p }],
                "shift",
                -s,
                t
              );
              ...
              var w = [
                { type: "elem", elem: n, shift: f, marginRight: p },
                { type: "elem", elem: a, shift: -s, marginRight: p },
              ];
              if (r instanceof d.default.symbolNode) {
          ...
          E.genfrac = function (e, t) {
            ...
            if (v === 0) {
              ...
              if (p - l.depth - (w + 0.5 * v) < m) {
                p += m - (p - l.depth - (w + 0.5 * v));
              }
              if (w - 0.5 * v - (s.height - g) < m) {
                g += m - (w - 0.5 * v - (s.height - g));
              }
              var b = -(w - 0.5 * v);
              y = c.default.makeVList(
                [
                  { type: "elem", elem: s, shift: g },
                  { type: "elem", elem: f, shift: b },
                  { type: "elem", elem: l, shift: -p },
                ],
                "individualShift",
                null,
          ...
          E.spacing = function (e, t) {
            if (
              ...
              if (e.mode === "text") {
                ...
                return (0, u.makeSpan)(
                  ["mspace"],
                  [c.default.mathsym(e.value, e.mode, t)],
                  t
                );
              }
            } else {
              return (0, u.makeSpan)(
                ["mspace", c.default.spacingFunctions[e.value].className],
                [],
                t
              );
            }
          ...
          E.op = function (e, t) {
            ...
            var s = false;
            if (
              i.size === o.default.DISPLAY.size &&
              e.value.symbol &&
              !y.default.contains(l, e.value.body)
            ) {
              s = true;
            }
            var f = void 0;
            if (e.value.symbol) {
              ...
              f = c.default.makeSymbol(e.value.body, h, "math", t, [
                "mop",
                "op-symbol",
                s ? "large-op" : "small-op",
              ]);
            ...
            if (n) {
              ...
              if (a) {
                ...
                M = Math.max(
                  ...
                  t.fontMetrics().bigOpSpacing4 - k.height
                );
              }
              var S = void 0;
              var A = void 0;
              ...
              if (!r) {
                ...
                S = c.default.makeVList(
                  [
                    ...
                    { type: "elem", elem: k, marginLeft: -x + "em" },
                    { type: "kern", size: M },
                    { type: "elem", elem: f },
                  ],
                  "top",
                ...
                S = c.default.makeVList(
                  [
                    { type: "elem", elem: f },
                    { type: "kern", size: b },
                    { type: "elem", elem: w, marginLeft: x + "em" },
                    { type: "kern", size: t.fontMetrics().bigOpSpacing5 },
                  ],
                  "bottom",
                  T,
          ...
          E.mod = function (e, t) {
            ...
            if (e.value.modType === "bmod") {
              if (!t.style.isTight()) {
                r.push(
                  (0, u.makeSpan)(["mspace", "negativemediumspace"], [], t)
                );
              }
            ...
            if (e.value.modType !== "pod") {
              var a = [
                c.default.mathsym("m", e.mode),
                c.default.mathsym("o", e.mode),
                c.default.mathsym("d", e.mode),
              ];
              if (e.value.modType === "bmod") {
          ...
          E.katex = function (e, t) {
            ...
            i.height = i.height - 0.2155;
            i.depth = i.depth + 0.2155;
          ...
          E.overline = function (e, t) {
            ...
            var n = c.default.makeVList(
              [
                { type: "elem", elem: r },
                { type: "kern", size: 3 * a.height },
                { type: "elem", elem: a },
                { type: "kern", size: a.height },
              ],
              "firstBaseline",
              null,
              t
          ...
          E.delimsizing = function (e, t) {
            ...
            return h.default.sizedDelim(r, e.value.size, t, e.mode, [
              e.value.mclass,
            ]);
          };
          E.leftright = function (e, t) {
            ...
            if (e.value.left === ".") {
              ...
              s = h.default.leftRightDelim(e.value.left, a, n, t, e.mode, [
                "mopen",
              ]);
            }
            r.unshift(s);
            ...
            if (e.value.right === ".") {
              ...
              d = h.default.leftRightDelim(e.value.right, a, n, t, e.mode, [
                "mclose",
              ]);
            }
            r.push(d);
          ...
          E.accentUnder = function (e, t) {
            ...
            var n = /tilde/.test(e.value.label) ? 0.12 : 0;
          ...
          E.xArrow = function (e, t) {
            ...
            var o = -t.fontMetrics().axisHeight - l.height - 0.111;
            var f = void 0;
            if (e.value.below) {
              var h = -t.fontMetrics().axisHeight + i.height + l.height + 0.111;
              f = c.default.makeVList(
                [
                  { type: "elem", elem: n, shift: o },
          ...
          var L = function e(t, r, a) {
            ...
            if (E[t.type]) {
              ...
              throw new l.default(
                "Got group of unknown type: '" + t.type + "'"
              );
            }
          };
          var P = function e(t, r) {
      ...
      36: [
        function (e, t, r) {
          ...
          k.genfrac = function (e, t) {
            var r = new o.default.MathNode("mfrac", [
              S(e.value.numer, t),
              S(e.value.denom, t),
            ]);
            if (!e.value.hasBarLine) {
          ...
          k.sqrt = function (e, t) {
            var r = void 0;
            if (e.value.index) {
              r = new o.default.MathNode("mroot", [
                S(e.value.body, t),
                S(e.value.index, t),
              ]);
            } else {
          ...
          k.katex = function (e) {
            var t = new o.default.MathNode("mtext", [
          ...
          k.horizBrace = function (e, t) {
            var r = y.default.mathMLnode(e.value.label);
            return new o.default.MathNode(e.value.isOver ? "mover" : "munder", [
              S(e.value.base, t),
              r,
            ]);
          };
          ...
          var A = function e(t, r, n) {
            ...
            var s = new o.default.MathNode("annotation", [
              new o.default.TextNode(r),
            ]);
        ...
        function (e, t, r) {
          ...
          var m = function e(t, r) {
            if (h.default.math[t] && h.default.math[t].replace) {
              return c.default.getCharacterMetrics(
                h.default.math[t].replace,
                r
              );
            } else {
          ...
          var y = function e(t, r, a) {
            ...
            var i =
              (1 - r.sizeMultiplier / n.sizeMultiplier) *
          ...
          var b = function e(t, r, a, n, i, o) {
            var u = w(t, r, i, n);
            var c = g(
              (0, s.makeSpan)(["delimsizing", "size" + r], [u], n),
              l.default.TEXT,
              n,
              o
            );
          ...
          var k = function e(t, r, a) {
            ...
            var i = (0, s.makeSpan)(
              ["delimsizinginner", n],
              [(0, s.makeSpan)([], [o.default.makeSymbol(t, r, a)])]
            );
          ...
          var M = function e(t, r, a, n, i, u) {
            ...
            return g(
              (0, s.makeSpan)(["delimsizing", "mult"], [P], L),
              l.default.TEXT,
              n,
              u
            );
          ...
          var q = [
            { type: "small", style: l.default.SCRIPTSCRIPT },
            { type: "small", style: l.default.SCRIPT },
            { type: "small", style: l.default.TEXT },
            { type: "large", size: 1 },
            { type: "large", size: 2 },
            { type: "large", size: 3 },
            { type: "large", size: 4 },
            ...
            (0, l.default)(e, [
              {
                ...
                value: function t(r) {
                  if (
                    ...
                    !(r instanceof e) ||
                    this.italic > 0 ||
                    h(this.classes) !== h(r.classes) ||
                    this.skew !== r.skew ||
                    this.maxFontSize !== r.maxFontSize
                  ) {
                    return false;
                  }
                  for (var a in this.style) {
                  ...
                  for (var n in r.style) {
                    if (
                      r.style.hasOwnProperty(n) &&
                      this.style[n] !== r.style[n]
                    ) {
                      return false;
                    }
                  }
      ...
      43: [
        function (e, t, r) {
          ...
          c(
            ...
            { numArgs: 1, allowedInText: true, greediness: 3 },
            function (e, t) {
              var r = t[0];
              return {
                type: "color",
          ...
          c(
            ...
            function (e, t) {
              ...
              var i =
                !a ||
                n.default.contains(["\\widehat", "\\widetilde"], e.funcName);
              return {
                type: "accent",
                label: e.funcName,
                isStretchy: a,
        ...
        function (e, t, r) {
          ...
          var f = function e(t, r) {
            ...
            if (i.contains(["widehat", "widetilde", "undertilde"], n)) {
              ...
              if (h > 5) {
                ...
                var v = [1, 1, 2, 2, 3, 3][h];
                if (n === "widehat") {
                  l = [0, 0.24, 0.3, 0.3, 0.36, 0.36][h];
                  u = "widehat" + v;
                } else {
                  l = [0, 0.26, 0.3, 0.3, 0.34, 0.34][h];
                  u = "tilde" + v;
                }
              }
            } else {
            ...
            p.innerHTML =
              "<svg width='100%' height='" + m + "em'" + c[u] + "</svg>";
            return p;
          };
          var h = function e(t, r, n, i) {
            ...
            if (r === "fbox") {
              ...
              l = a.makeSpan([], [], i);
              l.innerHTML =
                "<svg width='100%' height='" + s + "em'>" + c[r] + "</svg>";
            }
            l.height = s;
            l.style.height = s + "em";
            return l;
